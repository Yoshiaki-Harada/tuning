...
import *  as domainModule from '../../domain/post';
...
describe('匿名でポストするテスト', () => {
    it('threadIdがある場合はリプライする', async () => {
        ...
        const stub = ImportMock.mockFunction(domainModule, 'createThreadId', threadId);
        ...
        it('threadIdがない場合はチャンネルにポストする', async () => {
            ...
            const stub = ImportMock.mockFunction(domainModule, 'createThreadId', null);
